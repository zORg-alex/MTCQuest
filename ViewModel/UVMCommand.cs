...
namespace MTCQuest.ViewModel {
	...
	/// With <see cref="UVMCommandHost"/> and <see cref="UVMCommandHostToUVMCommandConverter"/> and <see cref="UVMCommandHostToUVMCommandConverter"/>
	...
	///	}));
	///	
	///	//And finally in xaml command to Commands with a converter parameter with command name and an object in a parameter to get commands from
	///		<SharedLib:UVMCommandHostToUVMCommandConverter x:Key="UVMCommandHostToUVMCommandConverter"/>
